...
CREATE TABLE IF NOT EXISTS users (
    ...
    status INT DEFAULT 1, -- 1:正常 2:管理员 0:禁用
...
CREATE TABLE IF NOT EXISTS posts (
    ...
    trade_type INT NOT NULL, -- 1:求购 2:出售 3:做多 4:做空
    delivery_date DATE,
...
CREATE TABLE IF NOT EXISTS point_transactions (
    id BIGINT PRIMARY KEY DEFAULT (uuid_number()::BIGINT),
    user_id BIGINT NOT NULL REFERENCES users(id) ON DELETE CASCADE,
    change_type INT NOT NULL, -- 1:充值 2:发布 3:查看 4:奖励 5:退还
...
CREATE TABLE IF NOT EXISTS sms_codes (
    ...
    status INT DEFAULT 1, -- 1:有效 0:已使用/已过期
